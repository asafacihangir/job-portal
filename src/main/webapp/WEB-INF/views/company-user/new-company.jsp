            ...
            <div class="panel-body">
                <form:form class="form-horizontal" action="${pageContext.request.contextPath}/company/saveCompany" modelAttribute="newCompany">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 col-md-3 col-lg-3 control-label">Ünvan</label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 col-md-3 col-lg-3 control-label">Adres</label>
                        <div class="col-sm-8 col-md-6 col-lg-5">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 col-md-3 col-lg-3 control-label">Web Stesi</label>
                        <div class="col-sm-8 col-md-6 col-lg-5">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 col-md-3 col-lg-3 control-label">Tasarımcı Sayısı</label>
                        <div class="col-sm-8 col-md-6 col-lg-5">
